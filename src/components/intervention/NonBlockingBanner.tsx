...
export function NonBlockingBanner({ intervention, reasons, onClick, onDismiss }: InterventionSurfaceProps) {
  return (
    <section className="fk-intervention mx-auto flex w-full max-w-fk items-center gap-3 border-b border-fk-border bg-white px-4 py-3 pl-5" role="status" aria-live="polite" data-testid="intervention-banner">
